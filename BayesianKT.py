if __name__ == '__main__':
    ...
    observation_sequence_lengths = np.full(500, 100,
                                           dtype=np.int)  # specifies 500 students with 100 observations for synthetic data
    ...
    while not done:
        if i == max_num_fit_initializations:
            break
        i += 1
        print('\niter %d' % i)
