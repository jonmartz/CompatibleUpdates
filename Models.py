...
#                  max_train_epochs=1000, diss_weight=None, old_model=None, copy_h1_weights=True, history=None,
#                  initial_std=1, weights_seed=1, regularization=0.0, ensemble_lr=1.0, early_stop_mode='none',
#                  performance_tier_size=0.01, max_same_tier_spree=100):
#
...
#                     hist_loss = tf.nn.sigmoid_cross_entropy_with_logits(labels=hist_y, logits=hist_logits,
